...
%token T_IF        "if (T_IF)"
%token T_WHETHER   "whether (T_WHETHER)"
%token T_IN   "in (T_IN)"
%right T_SET 
...
unticked_statement:
	...
	|	T_WHETHER parenthesis_expr { zend_do_whether_cond(&$2, &$1 TSRMLS_CC); } statement { zend_do_if_after_statement(&$1, 1 TSRMLS_CC); zend_do_if_end(TSRMLS_C); }
	...
	|	T_SET expr T_TO T_STRING { zend_do_set(&$2, &$4 TSRMLS_CC); }
...
expr_without_variable:
	...
	|	expr T_IN expr	{ zend_do_in_op(&$$, &$1, &$3 TSRMLS_CC); }
